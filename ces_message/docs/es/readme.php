...
@todo Incluir en el listado de los mensajes: 
      ...
      Al borrar el mensaje el usuario marcar como borrado, pero mantener en la 
...
@todo Documentar para doxygen, sobretodo la parte de implementar una acción nueva.
